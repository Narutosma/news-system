...
import SandDraft from '../../../components/SandBox/SandDraft';
import { getCategories, addNews } from '../../../api';
...
export default function Add() {
    ...
    const submitHandle = state => {
        ...
        addNews(formData).then(res => {
            ...
            notification.info({
                message: `通知`,
                description: `你可以${state === 0?'草稿箱':'审核列表'}到查看你的新闻`,
    ...
    return (
        <div>
            ...
            <div className={currentStep === 1 ? "" : style.active}>
                <SandDraft onHandle={value => setContent(value)}/>
            </div>
            <div>
                {
